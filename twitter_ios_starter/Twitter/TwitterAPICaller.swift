...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "T6YgTvjugINtQZOz2p0f21n7C", consumerSecret: "jcrgYlyueD650boBOKvdSGJowZTArA9pOoqop6WHze07xFYOdk")
    var loginSuccess: (() -> ())?
